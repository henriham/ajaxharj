            ...
            if(typeof obj.data == 'object'){
                for(var i = 0; i < obj.data.length; i++){
                    ...
                    <td>
                        ...
                        <button onclick="delete_row(${row.id})" class="btn btn-danger btn-sm">Poista</button>
                    </td>    
                    </tr>`;
                }
...
// funktio add new user -> save changes napille, SULKEE SEN!
function add_new(e){
        e.preventDefault();
        let obj = {};
    ...
    function delete_row(id)
    {
        ...
        if(!confirm("Poistetaanko rivi "+id+"?"))
        {
            return;
        }
